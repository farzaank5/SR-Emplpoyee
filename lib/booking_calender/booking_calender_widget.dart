...
import 'booking_calender_model.dart';
export 'booking_calender_model.dart';
...
class BookingCalenderWidget extends StatefulWidget {
  ...
  @override
  _BookingCalenderWidgetState createState() => _BookingCalenderWidgetState();
}

class _BookingCalenderWidgetState extends State<BookingCalenderWidget> {
  late BookingCalenderModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingCalenderModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<TotalBookingRecord>>(
      stream: queryTotalBookingRecord(
        queryBuilder: (totalBookingRecord) => totalBookingRecord.where(
          'placeRef',
      ...
      builder: (context, snapshot) {
        ...
        List<TotalBookingRecord> bookingCalenderTotalBookingRecordList =
            snapshot.data!;
                                          ...
                                          builder: (context) {
                                            final disable = functions
                                                    .monthNameToCalander(
                                                        ...
                                                        functions
                                                            .inBetweenday(
                                                                bookingCalenderTotalBookingRecordList
                                                                    .map((e) => e
                                                                        .startDate)
                                                                    .withoutNulls
                                                                    .toList(),
