...
import 'current_bookings_model.dart';
export 'current_bookings_model.dart';

class CurrentBookingsWidget extends StatefulWidget {
  const CurrentBookingsWidget({Key? key}) : super(key: key);

  @override
  _CurrentBookingsWidgetState createState() => _CurrentBookingsWidgetState();
}

class _CurrentBookingsWidgetState extends State<CurrentBookingsWidget>
    with TickerProviderStateMixin {
  late CurrentBookingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CurrentBookingsModel());
