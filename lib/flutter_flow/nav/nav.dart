...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/villasBookingDetails',
          builder: (context, params) => VillasBookingDetailsWidget(
            ...
            totalGuests: params.getParam(
                'totalGuests', ParamType.DocumentReference, false, ['villas']),
        ...
        FFRoute(
          ...
          path: '/villasDetailsfromlist',
          builder: (context, params) => VillasDetailsfromlistWidget(
            placeRef: params.getParam(
                'placeRef', ParamType.DocumentReference, false, ['villas']),
          ),
        ),
