...
import 'bookingshistory_model.dart';
export 'bookingshistory_model.dart';

class BookingshistoryWidget extends StatefulWidget {
  const BookingshistoryWidget({Key? key}) : super(key: key);
...
class _BookingshistoryWidgetState extends State<BookingshistoryWidget>
  ...
  late BookingshistoryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BookingshistoryModel());
